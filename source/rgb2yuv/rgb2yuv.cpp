...
const char *srcFileName = "/home/ubuntu/gaotianpeng/arm_x86_anbox_test/720p.yuv";
const char *dstFileName = "/home/ubuntu/gaotianpeng/arm_x86_anbox_test/720pp.rgb";

using namespace std;

int main(int argc, char* argv[]) {
	cout << "hello ffmpeg test" << endl;
	...
	std::cout << "hello ffmpeg start" << std::endl;
	bool bExit = false;
	while (!bExit) {
	...
	std::cout << "hello ffmpeg end" << endl;
